    ...
    <div className="container mx-auto px-4 space-y-24">
      ...
      <div className="flex justify-center gap-8 opacity-50">
        {[1, 2, 3, 4].map((i) => (
          <div
            key={i}
            className="h-12 w-32 bg-base-200 rounded-lg animate-pulse"
          />
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
          <div
            key={i}
            className="h-[400px] bg-base-200 rounded-2xl animate-pulse"
          />
        ))}
      </div>
    </div>
  ...
  <div className="py-10 border-b border-base-200 bg-base-100">
    <div className="container mx-auto px-4 text-center">
      <p className="text-sm font-bold uppercase tracking-widest opacity-40 mb-6">
        Trusted by Municipalities & Organizations
      </p>
      ...
      <div className="bg-base-200 rounded-[3rem] p-12 md:p-0 flex flex-col md:flex-row items-center relative">
        ...
        <div className="md:w-1/2 md:p-16 z-10">
          ...
          <p className="text-lg opacity-70 mb-8">
            No app download needed. Our platform is fully optimized for your
            phone. Snap a photo, tag the location, and hit send in seconds.
          </p>
        ...
        <div className="md:w-1/2 relative h-[400px] md:h-[500px] w-full flex items-end justify-center overflow-hidden">
          ...
          <div className="relative z-10 transform translate-y-10 md:translate-y-0">
            ...
            <div className="absolute top-[12%] left-[10%] right-[10%] bottom-[12%] bg-base-100 rounded-3xl overflow-hidden flex flex-col items-center justify-center border-2 border-base-200">
              ...
              />
              <p className="mt-4 font-bold text-lg text-base-content">
                Location Detected
              </p>
  ...
  const reviews = [
    {
      name: "Sarah K.",
      role: "Resident",
      text: "Finally, a way to actually get the potholes on my street fixed. The updates were real-time!",
    },
    {
      name: "James L.",
      role: "Volunteer",
      text: "I love the community events feature. It's great to see neighbors coming together.",
    },
    {
      name: "Dr. Alom",
      role: "City Official",
      text: "This platform helps us prioritize the most critical infrastructure needs efficiently.",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4">
            Community <span className="text-secondary">Voice</span>
          </h2>
          <p className="opacity-60">
            Hear from the people making a difference.
          </p>
        </div>
    ...
    <div className="container mx-auto bg-gradient-to-r from-secondary to-accent rounded-[3rem] p-12 md:p-20 text-center text-white relative overflow-hidden shadow-2xl">
      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        ...
        <p className="text-lg md:text-xl opacity-90 mb-8 leading-relaxed">
          Join thousands of proactive citizens today. Report an issue in
          seconds.
        </p>
        <Link
          to="/auth/register"
          className="btn btn-lg bg-white text-secondary hover:bg-base-100 border-none rounded-full px-10 shadow-lg font-bold"
        >
