    ...
    <StyledWrapper>
      <ul className="example-1 bg-neutral">
        <li className="icon-content">
          ...
          <div className="tooltip bg-base-100 text-base-content">Facebook</div>
        </li>
        <li className="icon-content">
          <a
          ...
          >
            <svg version="1.1" viewBox="0 0 100 100" xmlSpace="preserve" fill="currentColor">
          ...
          <div className="tooltip bg-base-100 text-base-content">Instagram</div>
        </li>
        <li className="icon-content">
          <a
          ...
          <div className="tooltip bg-base-100 text-base-content">Twitter</div>
        </li>
        <li className="icon-content">
          <a
          ...
          <div className="tooltip bg-base-100 text-base-content">Mail</div>
        </li>
      </ul>
    </StyledWrapper>
  );
