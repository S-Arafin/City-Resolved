        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm opacity-70 leading-relaxed font-medium max-w-xs">
              Empowering citizens to build better cities. Report issues, track
              resolutions, and bridge the gap between community and
              administration.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm font-medium">
              {[
                { to: "/", label: "Home" },
                { to: "/all-issues", label: "Reported Issues" },
                { to: "/community", label: "City Stats" },
